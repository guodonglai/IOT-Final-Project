...
window.title("Plant Doctor")

window.geometry("700x700")
window.configure(background ="green")

title = tk.Label(text="Click below to choose picture for testing disease....", background = "green", fg="Black", font=("", 15))
title.grid()
def analysis():
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='/home/pi/Desktop/Project/PlantDiseaseDetection/flowerPicture', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "/home/pi/Desktop/Project/PlantDiseaseDetection/testpicture"
...
def takePicture():
    ...
    sleep(5)
    camera.capture('/home/pi/Desktop/Project/PlantDiseaseDetection/flowerPicture/flower.jpg')
    camera.stop_preview()
def CheckStatus():
    webbrowser.open('http://thingspeak.com/channels/640271/private_show')
def Temp():
    webbrowser.open('http://thingspeak.com/channels/640331/private_show')
def Brightness():
    webbrowser.open('http://thingspeak.com/channels/640332/private_show')
def exit():
    window.destroy()
    
button1 = tk.Button(text="Get Photo", command = openphoto)
button1.grid(column=0, row=1, padx=10, pady = 10)
button2 = tk.Button(text="Take Photo", command = takePicture)
button2.grid(column=0, row=2, padx=10, pady = 10)
button3 = tk.Button(text="Check Moisture", command = CheckStatus)
button3.grid(column=0, row=3, padx=10, pady = 10)
button3 = tk.Button(text="Check Temp", command = Temp)
button3.grid(column=0, row=4, padx=10, pady = 10)
button3 = tk.Button(text="Check Brightness", command = Brightness)
button3.grid(column=0, row=5, padx=10, pady = 10)
button4 = tk.Button(text="Exit", command = quit)
button4.grid(column=0, row=7, padx=10, pady = 10)
